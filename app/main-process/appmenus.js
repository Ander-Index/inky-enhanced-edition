      ...
      if (snippet.separator) {
        ...
        return {
          ...
          click: (item, focussedWindow) =>
            callbacks.insertSnippet(focussedWindow, snippet.ink),
        };
      }
    });
    ...
    function createSnippetMenuItems(menuItemsArray, parentMenuItem) {
      ...
      for (let menuItem of menuItemsArray) {
        ...
        if (menuItem.separator) {
          ...
          if (menuItem.ink) {
            templateMenuItem.click = (item, focussedWindow) =>
              callbacks.insertSnippet(focussedWindow, menuItem.ink);
            valid = true;
        ...
        if (valid) parentMenuItem.submenu.push(templateMenuItem);
      }
    }
              ...
              click(item, focusedWindow) {
                ...
                dialog
                  .showMessageBox(focusedWindow, {
                    ...
                    title: i18n._("Reload?"),
                    message: i18n._(
                      "Are you sure you want to reload the current window? Any unsaved changes will be lost.",
                    ),
                  })
                  .then((result) => {
...
exports.AppMenus = {
  ...
  setCustomSnippetMenus: (snippets) => {
    customInkSnippets = snippets;
  },
  refresh: refresh,
};
